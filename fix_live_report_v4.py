...
live_report_target = """        <!-- CARD 5: Live Report Carousel -->
...
live_report_replacement = """        <!-- CARD 5: Live Report Carousel -->
        <div class="card" data-id="5">
            <div class="carousel-indicators" id="car-ind-live">
                <div class="c-ind active"></div>
                <div class="c-ind"></div>
            ...
            <div class="carousel-container" onscroll="updateCarousel(this, 'car-ind-live')">
                    ...
                    <div class="card-info" style="bottom: 40px; right: 16px;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 8px; margin-top: 12px; margin-bottom: 12px;">
                            <div style="display: flex; gap: 12px; align-items: flex-start;">
                                <div style="font-size: 11px; color: var(--detik-blue); font-weight: 700; width: 50px; flex-shrink: 0; padding-top: 2px;">10:45</div>
                                <div style="font-size: 13px; border-left: 2px solid var(--detik-blue); padding-left: 10px;">Rapat diskors sementara karena interupsi fraksi terkait anggaran.</div>
                            </div>
                            <div style="display: flex; gap: 12px; align-items: flex-start;">
                                <div style="font-size: 11px; color: var(--detik-blue); font-weight: 700; width: 50px; flex-shrink: 0; padding-top: 2px;">10:15</div>
                                <div style="font-size: 13px; border-left: 2px solid var(--detik-blue); padding-left: 10px;">Ketua DPR membuka sidang dengan agenda utama...</div>
                            </div>
                            <div style="display: flex; gap: 12px; align-items: flex-start;">
                                <div style="font-size: 11px; color: var(--detik-blue); font-weight: 700; width: 50px; flex-shrink: 0; padding-top: 2px;">09:30</div>
                                <div style="font-size: 13px; border-left: 2px solid var(--detik-blue); padding-left: 10px;">Anggota dewan mulai memasuki ruang rapat paripurna.</div>
                            </div>
                        </div>
                        
                        <div style="font-size:12px;color:#aaa;margin-top:16px">Swipe ke kiri untuk update timeline yang dikurasi <i class="fa-solid fa-arrow-right"></i></div>
                    </div>
                </div>
                ...
                <div class="carousel-slide">
                    ...
                    <div class="card-info" style="bottom: 40px; right: 16px;">
                        ...
                        <div class="trust-element"><i class="fa-solid fa-link"></i> <a href="https://news.detik.com/berita/d-123456" target="_blank" style="color:#ccc; text-decoration:underline;">Sumber: detikNews (Langsung dari DPR)</a></div>
                        <h2 class="card-title" style="font-size: 20px; margin-top: 8px;">Rapat Diskors Sementara</h2>
                        <div class="update-card" style="margin-top: 12px; background: rgba(255,255,255,0.05); border:none; border-left: 3px solid var(--detik-blue); border-radius:0;">
                            <div class="update-text">Rapat diskors sementara karena interupsi fraksi terkait anggaran. Suasana sempat memanas hingga palu sidang dijeda.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-slide">
                    ...
                    <div class="card-info" style="bottom: 40px; right: 16px;">
                        ...
                        <div class="trust-element"><i class="fa-solid fa-link"></i> <a href="https://news.detik.com/berita/d-123457" target="_blank" style="color:#ccc; text-decoration:underline;">Sumber: Tim detikcom</a></div>
                        <h2 class="card-title" style="font-size: 20px; margin-top: 8px;">Ketua DPR Membuka Sidang</h2>
                        <div class="update-card" style="margin-top: 12px; background: rgba(255,255,255,0.05); border:none; border-left: 3px solid var(--detik-blue); border-radius:0;">
                            <div class="update-text">Ketua DPR membuka sidang dengan agenda utama pengesahan RUU Perimbangan Keuangan. Sebanyak 320 anggota hadir.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-slide">
                    ...
                    <div class="card-info" style="bottom: 40px; right: 16px;">
                        ...
                        <div class="trust-element"><i class="fa-solid fa-link"></i> <a href="https://foto.detik.com/d-123458" target="_blank" style="color:#ccc; text-decoration:underline;">Fotografer: detikFoto (Pintu Masuk DPR)</a></div>
                        <h2 class="card-title" style="font-size: 20px; margin-top: 8px;">Pengamanan Diperketat</h2>
                        <div class="update-card" style="margin-top: 12px; background: rgba(255,255,255,0.05); border:none; border-left: 3px solid var(--detik-blue); border-radius:0;">
                            <div class="update-text">Anggota dewan mulai memasuki ruang rapat paripurna. Pengamanan diperketat menyusul adanya laporan demonstrasi.</div>
                        </div>
                    </div>
                </div>
            </div>"""

if live_report_target in text:
    text = text.replace(live_report_target, live_report_replacement)
else:
